      ...
      <div className="container mx-auto max-w-4xl space-y-8">
        ...
        {isLoading ? (
          ...
          <>
            ...
            {/* REJECTED REQUESTS NOTIFICATIONS */}
            {friendRequests?.rejectedReqs?.length > 0 && (
              <section className="space-y-4">
                <h2 className="text-xl font-semibold flex items-center gap-2">
                ...
                <div className="space-y-3">
                  {friendRequests.rejectedReqs.map((notification) => (
                    <div
                      key={notification._id}
                      className="card bg-base-200/50 border border-error/20 shadow-sm"
                    >
                      <div className="card-body p-4">
                        <div className="flex items-start gap-3">
                          <div className="avatar mt-1 size-10 rounded-full opacity-70">
                            <img
                              src={
